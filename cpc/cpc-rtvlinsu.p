...
then do:
    ...
    then do:     
		...
		then do:
            /* GLPI-72962 */
            if round(tmp-cpc-rtvlinsu-saida.vl-insumo, 2) <> 0 
            then assign tmp-cpc-rtvlinsu-saida.vl-insumo = round(tmp-cpc-rtvlinsu-saida.vl-insumo, 2).
            else assign tmp-cpc-rtvlinsu-saida.vl-insumo = round(tmp-cpc-rtvlinsu-saida.vl-insumo, 4).
        end.
    end.
end.
/* ----------------------------------------------------------------------------------------------------------------- */
